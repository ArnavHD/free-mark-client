            ...
            <div className="card md:w-96 bg-base-100 shadow-sm">
              <div className="card-body">
                ...
                <p className="text-gray-500">
                  Budget-friendly and user-friendly, ideal for individuals and
                  small businesses seeking essential features for online
                  presence.
                </p>
          ...
          <div className="hover-3d ">
            <div className="card md:w-96 xl:pb-5  xl:pt-5 bg-base-100 shadow-sm">
              <div className="card-body ">
                ...
                <div className="flex justify-between">
                  <h2 className="text-2xl font-semibold">Economy Plan</h2>

                  <span className="text-xl">$29/mo</span>
                </div>
                <p className="text-gray-500">
                  Tailored for growth the Professional Package offers advanced
                  features, scalability, and priority support 24/7.
                </p>
                <ul className="mt-6 flex flex-col gap-2 text-xs">
                  <li>
                    <svg
          ...
          <div className="hover-3d">
            <div className="card md:w-96 bg-base-100 shadow-sm">
              <div className="card-body">
                ...
                <p className="text-gray-500">
                  Ultimate for large organizations, offering cutting-edge tech,
